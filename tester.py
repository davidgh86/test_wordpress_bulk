    ...
    if response.status_code == 200:
        ...
        for post in posts:
            ...
            if delete_response.status_code == 200:
                ...
                print(f"Failed to delete post {post['id']}: {delete_response.text}")
    else:
    ...
    if response.status_code == 200:
        ...
        for scheduler in schedulers:
            ...
            if delete_response.status_code == 200:
                ...
                print(f"Failed to delete scheduler {scheduler['id']}: {delete_response.text}")
    else:
        print(f"Failed to retrieve schedulers: {response.text}")
...
def create_expression(scheduler_data):
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to create scheduler: {response.text}")
        return None
